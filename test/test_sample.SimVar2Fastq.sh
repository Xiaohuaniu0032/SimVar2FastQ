...
bwa mem -M -R "@RG\tID:test_sample\tSM:test_sample\tPL:illumina" /data1/database/b37/human_g1k_v37.fasta /home/fulongfei/workdir/git_repo/SimVar2Fastq/test/test_sample.R1.fastq /home/fulongfei/workdir/git_repo/SimVar2Fastq/test/test_sample.R2.fastq | /home/fulongfei/miniconda3/bin/samtools view -b -o test_sample.bam -
/home/fulongfei/miniconda3/bin/samtools sort test_sample.bam -o test_sample.sort.Ins.30.bam
/home/fulongfei/miniconda3/bin/samtools index test_sample.sort.Ins.30.bam
rm test_sample.bam
